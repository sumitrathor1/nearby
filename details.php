...
<?php else: ?>
    ...
    <!-- Hidden Post ID for Reviews -->
    <input type="hidden" id="post-id" value="<?= (int)$accommodation['id'] ?>">
        ...
        <div class="col-lg-8">
            <article class="glass-card p-4">
                ...
                <header class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-3">
                    <div>
                        <span class="badge bg-success bg-opacity-75 text-white mb-2">
                            Allowed: <?= htmlspecialchars($accommodation['allowed_for']) ?>
                        </span>
                    ...
                    <div class="text-md-end">
                        <?php if ($accommodation['is_verified']): ?>
                            <span class="badge badge-verified">
                                <i class="bi bi-patch-check-fill me-1"></i>Owner Verified
                            </span>
                        <?php endif; ?>

                        <p class="fw-semibold text-success fs-5 mb-0">
                            ₹<?= number_format($accommodation['monthly_rent']) ?> / month
                        </p>
                    </div>
                </header>
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <?php else: ?>
                            <span class="text-muted small">
                                Owner has not listed facilities yet.
                            </span>
                        <?php endif; ?>
                    </div>
                </section>
            ...
            <div class="glass-card p-4 mt-4">
                <h2 class="h5 fw-semibold mb-3">Ratings & Reviews</h2>

                <div id="average-rating" class="mb-3 text-warning fw-semibold"></div>
        ...
        <div class="col-lg-4">
            <div class="glass-card p-4">
                ...
                <p class="fw-semibold mb-3">
                    ...
                    <?= htmlspecialchars($accommodation['owner_name']) ?>
                </p>
                ...
                <?php if (!empty($_SESSION['user'])): ?>
                    <div class="mb-4">
                        ...
                        <a class="text-decoration-none"
                           href="mailto:<?= htmlspecialchars($accommodation['owner_email']) ?>">
                           <?= htmlspecialchars($accommodation['owner_email']) ?>
                        </a>
                    </div>
                <?php else: ?>
                    <div class="alert alert-info alert-glass small">
                        Login to view contact details instantly and send a request to the owner.
                    </div>
                <?php endif; ?>

                <button class="btn btn-primary w-100"
                        data-contact-id="<?= (int)$accommodation['id'] ?>">
                        Contact Owner
                </button>

                <a class="btn btn-outline-light w-100 mt-3" href="search.php">
                    Back to search
                </a>
